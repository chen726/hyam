  ...
  Selectpicker.prototype = {
    ...
    createDropdown: function () {
      ...
      var drop =
          ...
          '<button type="button" style="background: #212121;padding: 7px 25px 7px 12px;border: 1px solid rgba(255, 255, 255, 0.12);" class="' + this.options.styleBase + ' dropdown-toggle" data-toggle="dropdown"' + autofocus + ' role="button">' +
