        ...
        g.VERSION = "1.11.0", g.DEFAULTS = {
            ...
            constructor: g, init: function () {
                ...
                var b = this.multiple || this.options.showTick ? " show-tick" : "",
                    ...
                    j = '<div class="btn-group bootstrap-select' + b + d + '"><button type="button"  style="background: #212121;padding: 5px 25px 7px 12px;border: 1px solid rgba(255, 255, 255, 0.12);" class="' + this.options.styleBase + ' dropdown-toggle" data-toggle="dropdown"' + e + ' role="button"><span class="filter-option pull-left"></span>&nbsp;<span class="bs-caret">' + this.options.template.caret + '</span></button><div class="dropdown-menu open" role="combobox">' + f + g + h + '<ul class="dropdown-menu inner" role="listbox" aria-expanded="false"></ul>' + i + "</div></div>";
                return a(j)
            }, createView: function () {
